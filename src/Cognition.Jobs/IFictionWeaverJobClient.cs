...
public interface IFictionWeaverJobClient
{
    ...
    string EnqueueLoreFulfillment(Guid planId, Guid requirementId, Guid agentId, Guid conversationId, Guid providerId, Guid? modelId = null, string branchSlug = "main", IReadOnlyDictionary<string, string>? metadata = null);
}
